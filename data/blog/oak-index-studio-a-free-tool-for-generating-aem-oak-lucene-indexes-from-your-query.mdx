...
draft: false
summary: 'OakUtils used to be the go-to tool for generating Oak Lucene indexes from AEM queries. It''s gone now, so I built Oak Index Studio to replace it with reasoning attached to every attribute, not just JSON.'
images: ['/static/posts/images/oak-index-studio.jpeg']
layout: PostLayout
isfeatured: true
---
...
![oak-index-studio.jpeg](/static/posts/images/oak-index-studio-2.jpeg)
...
The tool is live at [Oak Index Studio](https://oak-index-studio.netlify.app/). No signup, nothing installed, paste a query and it just runs.

It’s an independent, community-built project, not affiliated with or endorsed by Adobe. If you hit a bug, find a rule that doesn’t match what you’re seeing in your own repository, or just have a suggestion, email me at [admin@khalilganiga.in](mailto:admin@khalilganiga.in). I’d genuinely rather hear about it than have it sit there being wrong for someone else too.
