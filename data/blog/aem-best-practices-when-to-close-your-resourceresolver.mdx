...
draft: false
summary: When to close a ResourceResolver in AEM, when leaving it open is actually correct, and the resource-leak and session-reuse pitfalls that catch most developers.
images: []
layout: PostLayout
isfeatured: false
---
