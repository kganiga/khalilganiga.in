...
images: [/static/posts/images/quicklink-navigator1.webp]
layout: PostLayout
isfeatured: true
---
...
![Quicklink Navigator](/static/posts/images/quicklink-navigator1.webp)

![Quicklink Navigator](/static/posts/images/quicklink-navigator2.webp)
...
Currently, extension is not available on Google Chrome web store. But you can install the extension on Google chrome by following the below steps.
    ...
    - Enable Developer mode
        ![developer-mode](/static/posts/images/developer-mode.webp)
